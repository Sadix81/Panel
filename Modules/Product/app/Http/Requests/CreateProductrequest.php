...
class CreateProductrequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'material_id' => ['nullable', 'array', 'min:1'],
            'material_id.*' => ['nullable', 'exists:materials,id', 'integer', 'min:1'],
            'weight_id' => ['nullable', 'array', 'min:1'],
            'weight_id.*' => ['nullable', 'exists:weights,id', 'integer', 'min:1'],
    ...
    public function messages()
    {
        return [
            ...
            'material_id.array' => 'جنس ها باید به صورت آرایه ارسال شوند.',
            'material_id.min' => 'حداقل یک جنس باید انتخاب شود.',
            'material_id.*.exists' => 'جنس انتخاب شده معتبر نیست.',
            'weight_id.array' => 'وزن ها باید به صورت آرایه ارسال شوند.',
            'weight_id.min' => 'حداقل یک وزن باید انتخاب شود.',
            'weight_id.*.exists' => 'وزن انتخاب شده معتبر نیست.',
